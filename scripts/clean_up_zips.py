...
if __name__ == '__main__':
    ...
    mem_request = '1Gi'  # f'{mem_per_worker // 4096**3}Gi'  # Request memory in GiB
    mem_limit = '2Gi'  # f'{mem_per_worker // 1024**3 - 32}Gi'  # Leave some memory for the scheduler and other processes
    ...
    if namespace == 'default':
        namespace = 'dask-cluster-cleanzips'
