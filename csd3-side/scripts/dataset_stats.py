...
def gather_stats(root):
    ...
    print(f"Potential number of zipped files: {potential_zip_count}")
    print(f"Percentage of folders that could be zipped: {potential_zip_count/folder_count*100:.2f} %")
